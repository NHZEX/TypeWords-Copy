...
<template>
  <div class="text">
    如果按下键盘无反应，请检查您是否安装 <span class="text-3xl font-bold text-red-500">“视频调速” “Vim” “音视频增强”</span> 等插件/脚本，它们会拦截键盘按下事件，<span
    class="font-bold text-red">导致在本网站练习时按键无反应</span>，您可以根据以下步骤解决冲突：
  </div>
  <ul class="m-0">
